    ...
    <body>
        ...
        <div class="aba"> 
            ...
            <div class="conteudo">
                ...
                <br><br><br><br>
                <h1 style="margin-top: 50px;">Escolha o equipamento</h1>

                <form action="alt_equipamento.php" class="item-id2" method="POST">
                    <select name="equipamento" style="cursor: pointer" required id="profissional">  
                        <?php
                            for($i=0;$i<$row;$i++){
