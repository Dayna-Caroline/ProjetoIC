<?php
    ...
    // executa a query
        ...
        { 
            header("location: ../../front/requisitos/requisitos.php?e=2&proj=".$_GET['proj']."&pagina=1&busca=".$_GET['busca'].""); die();
        }
    //
                    ...
                    <?php
                        ...
                        if($row != 0)
                        {
                            ...
                            if( $row>10 )
                            {
                                ...
                                {
                                    header("location: ../../front/requisitos/requisitos.php?proj=".$_GET['proj']."&pagina=1&busca=".$_GET['busca']."&e=2"); die();
                                }
